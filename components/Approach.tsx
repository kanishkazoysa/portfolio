...
const Approach = () => {
  return (
    <section className="w-full py-20 max-w-6xl mx-auto">
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center
       dark:border-white/[0.2] max-w-xs w-full mx-auto p-4 relative lg:h-[35rem] rounded-3xl" // Adjusted width and height
      style={{
